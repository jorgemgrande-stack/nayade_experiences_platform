...
const TEMPLATES: TemplateDef[] = [
  ...
  },
  {
    ...
    buildPreview: () => buildReservationFailedHtml({
      ...
      activityName: "Kayak en el lago",
      activityDate: "20 de julio de 2026",
      locator: "NAY-2026-0043",
    }),
  },
  {
    ...
    buildPreview: () => buildConfirmationHtml({
      ...
      activityName: "SUP Yoga al amanecer",
      activityDate: "10 de septiembre de 2026",
      activityTime: "08:00",
      participants: 1,
      totalAmount: "45.00",
      locator: "NAY-2026-0044",
      paymentMethod: "Bizum",
      origin: "https://nayadeexperiences.es",
      reservationId: 44,
    }),
  },
  {
    ...
    buildPreview: () => buildTransferConfirmationHtml({
      ...
      activityName: "Curso de vela ligera",
      activityDate: "5 de octubre de 2026",
      activityTime: "09:00",
      participants: 3,
      totalAmount: "210.00",
      locator: "NAY-2026-0045",
      origin: "https://nayadeexperiences.es",
    }),
  },
  // ── PRESUPUESTOS ──────────────────────────────────────────────────────────
  {
    ...
    buildPreview: () => buildBudgetRequestUserHtml({
      ...
      phone: "612 345 678",
      activityType: "Actividad de team building acuático",
      participants: 25,
      preferredDate: "15 de noviembre de 2026",
      message: "Somos un grupo de empresa y nos gustaría organizar una jornada de team building con actividades acuáticas para 25 personas.",
      origin: "https://nayadeexperiences.es",
    }),
  },
  {
