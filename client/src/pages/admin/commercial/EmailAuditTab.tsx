...
const AUDIT_DATA: AuditEntry[] = [
  ...
  // ── PRESUPUESTOS ───────────────────────────────────────────────────────────
  {
    ...
    trigger: "Envío manual desde CRM + quoteReminderJob (recordatorio automático)",
    triggerType: "event",
    sendsToClient: true,
    sendsToAdmin: false,
    recipient: "client",
    ...
    hasBody: true,
    isCronDriven: true,
    cronSource: "quoteReminderJob (cada hora, sin flag)",
    status: "warning",
    notes: "Usado tanto por envío manual como por quoteReminderJob. El recordatorio automático no tiene feature flag.",
  },
  {
    id: "proposal",
    category: "Presupuestos",
  ...
  },
  {
    ...
    trigger: "commercialFollowupJob — primer recordatorio por regla",
    triggerType: "cron",
    sendsToClient: true,
    sendsToAdmin: false,
    recipient: "client",
    ...
    hasBody: true,
    isCronDriven: true,
    cronSource: "commercialFollowupJob (cada hora, flag: commercial_followup_job_enabled)",
    status: "ok",
  },
  {
    ...
    trigger: "commercialFollowupJob — segundo recordatorio por regla",
    triggerType: "cron",
    sendsToClient: true,
    sendsToAdmin: false,
    recipient: "client",
  ...
  },
  {
    ...
    trigger: "commercialFollowupJob — tercer recordatorio por regla",
    triggerType: "cron",
    sendsToClient: true,
    sendsToAdmin: false,
    recipient: "client",
