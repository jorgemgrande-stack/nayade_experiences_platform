/**
 * ActivarGestoria — Pantalla pública de activación de cuenta del Portal de Gestoría.
 *
 * Lee ?token=... de la URL, pide contraseña y llama a trpc.gestoria.portal.activate.
 * Tras el éxito redirige a /login?returnTo=/gestoria.
 */
...
export default function ActivarGestoria() {
  ...
  const activate = trpc.gestoria.portal.activate.useMutation({
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 max-w-sm w-full text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Bienvenido, {userName}. Ya puede acceder al Portal de Gestoría.
          </p>
          <Button
            className="w-full bg-orange-500 hover:bg-orange-600 text-white"
            onClick={() => navigate("/login?returnTo=/gestoria")}
          >
            Ir al portal
          </Button>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-sm w-full">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">Elige una contraseña para acceder al Portal de Gestoría</p>
        </div>
